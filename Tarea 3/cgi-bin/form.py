...
redes_sociales="""
    <label for="red-social">Redes Sociales</label>
            <select id="red-social" name="red-social" onclick="agregarRedSocial();">
                <option id="red-socialTwitter" value="Twitter">Twitter</option>
                <option id="red-socialInstagram" value="Instagram">Instagram</option>
                <option id="red-socialFacebook" value="Facebook">Facebook</option>
                <option id="red-socialTikTok" value="TikTok">Tiktok</option>
                <option id="red-socialOtra" value="Otra">Otra</option>
            </select>
"""
