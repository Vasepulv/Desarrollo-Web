...
valRed=validarRedSocial(red,red_social)
    ...
    try:
        with conn2.cursor() as cursor:
            ...
            if (result!=None and result!=()):
                ...
                nombreArchivo=fotos.filename
                pathNombre=os.path.abspath(nombreArchivo)
                cursor.execute(sql3,(pathNombre,nombreArchivo,result[0][0]))
                ...
                file=open(r"./image/"+fn,"x")
                file.close()
                picture=Image.open(fotos.file)
                picture=picture.save(r"./image/"+fn)
